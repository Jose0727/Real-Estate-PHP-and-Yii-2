        ...
        if ($model->load(Yii::$app->request->post())) { 
          ...
          $date=date('Y-m-d h:i:s');
           ...
           $i=1; foreach ($line_of_text as $key => $value) {
                 if($i!=1 && !empty($value)){
                  $sql = "INSERT INTO report_deposit_canada(user_id,amount,bank_name, payment_datet_ime,created_at,updated_at) VALUES ('$value[0]','$value[1]','$value[2]','$value[3]','$value[4]','$value[5]','$value[6]')";
