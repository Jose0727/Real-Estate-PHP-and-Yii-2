...
Each family member must go through the Sign Up process.<br>
Each family Member must have a unique email address.<br>
The APG Acts as the Agent to verify the identity for each family member.<br>
Infants under the age of 5 can have a Parent do the sign up.<br><br>
Children who can log on by them self can use the services.<br>
